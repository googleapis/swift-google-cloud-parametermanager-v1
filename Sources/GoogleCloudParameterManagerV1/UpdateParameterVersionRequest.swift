...
public struct UpdateParameterVersionRequest: Codable, Equatable, GoogleCloudWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `UpdateParameterVersionRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = UpdateParameterVersionRequest().with { $0.updateMask = ... }
  /// ```
