...
public struct UpdateTemplateRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `UpdateTemplateRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = UpdateTemplateRequest().with { $0.updateMask = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.parametermanager.v1.UpdateTemplateRequest"
  }
