...
public struct GetTemplateVersionRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `GetTemplateVersionRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = GetTemplateVersionRequest().with { $0.name = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.parametermanager.v1.GetTemplateVersionRequest"
  }
