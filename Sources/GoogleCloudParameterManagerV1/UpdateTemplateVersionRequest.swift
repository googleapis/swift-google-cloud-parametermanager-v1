...
public struct UpdateTemplateVersionRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `UpdateTemplateVersionRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = UpdateTemplateVersionRequest().with { $0.updateMask = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.parametermanager.v1.UpdateTemplateVersionRequest"
  }
