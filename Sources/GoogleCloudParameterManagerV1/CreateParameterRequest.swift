...
public struct CreateParameterRequest: Codable, Equatable, GoogleCloudWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `CreateParameterRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = CreateParameterRequest().with { $0.parent = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.parametermanager.v1.CreateParameterRequest"
  }
