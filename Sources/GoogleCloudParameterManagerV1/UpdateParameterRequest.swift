...
public struct UpdateParameterRequest: Codable, Equatable, GoogleCloudWKT._AnyPackable,
  Sendable
{
  ...
  public var parameter: Parameter? = nil
  ...
  /// Initialize a new instance of `UpdateParameterRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = UpdateParameterRequest().with { $0.updateMask = ... }
  /// ```
  ...
  public init(from decoder: Decoder) throws {
    ...
    self.parameter = try container.decodeIfPresent(Parameter.self, forKey: .parameter)
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.parametermanager.v1.UpdateParameterRequest"
  }
