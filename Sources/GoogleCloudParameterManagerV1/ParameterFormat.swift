...
/// and is immutable.
public enum ParameterFormat: Codable, Equatable, Sendable {
  ...
  public var stringValue: Swift.String? {
    switch self {
    case .unspecified: return "PARAMETER_FORMAT_UNSPECIFIED"
  ...
  ///
  /// If the value is unknown, this initializes to [`unknownStringValue`](doc:ParameterFormat/unknownStringValue(_:)).
  public init(stringValue: Swift.String) {
    switch stringValue {
    case "PARAMETER_FORMAT_UNSPECIFIED": self = .unspecified
    case "UNFORMATTED": self = .unformatted
    case "YAML": self = .yaml
    case "JSON": self = .json
  ...
  ///
  /// If the value is unknown, this initializes to [`unknownIntValue`](doc:ParameterFormat/unknownIntValue(_:)).
