# Google Cloud Client Libraries for Swift - Parameter Manager API
...
```bash
swift package add-dependency https://github.com/googleapis/swift-google-cloud-parametermanager-v1.git --from 0.2.0
```
